class TeCla {
  static const totoU =
      'https://docs.google.com/document/d/1IaKU2s262xtwmfz_EfLgf6YxMgbAgvEaMn30eH80Yxc/edit';
}

(int, (String, String))
    fsdfmdmgmdsfmiosemoifsimsdfimdsfiodsfospppppgpgpgppgppgpppg() {
  var dfdfvdfvdfvdfa = '';
  ...
  return (
    3213212,
    (
      'sdfiuhsdfihdfshiusdfihusdfgiuewiouhnwenuvteu',
      'wufewneqruefuyfeiuwyweiruygiu'
    )
  );
}
